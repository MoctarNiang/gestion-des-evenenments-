    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav flex-grow-1 justify-content-between">
          ...
          <li class="nav-item"><a class="nav-link" href="memebre.php">MEMBRE</a></li>
          <li class="nav-item"><a class="nav-link" href="dashboard.php">GESTION</a></li>
          <li class="nav-item"><a class="nav-link" href="clients.php">CLIENTS</a></li>
          <li><a href="rservationclients.php" class="nav-link px-2">RESERVATION DES CLIENTS</a></li>
